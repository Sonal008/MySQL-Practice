CREATE TABLE Employees(
	...
	Status varchar(50) ,
	HireDate datetime ,
	BenefitDental varchar(50) ,
	BenefitMedical varchar(50) ,
	BenefitRetirement varchar(50) ,
	Salary int ,
	JobRating int 
);
...
SELECT * FROM Employees WHERE Department = 'Account Management';

SELECT *FROM Employees WHERE Department = 'Account Management' AND Status = 'Full Time';

SELECT * FROM Employees WHERE Department = 'Account Management' AND Status = 'Full Time' AND Salary >80000;

SELECT EmployeeID, Salary, First, Last FROM Employees WHERE Department = 'Account Management';

SELECT Department,EmployeeId,First,Last,Status,Salary FROM Employees WHERE Salary = 61030;

SELECT * FROM Employees;

SELECT * FROM Employees WHERE Department = 'Manufacturing' OR JobRating = 2;
...
SELECT count(DISTINCT(Status)) FROM Employees;
...
ALTER TABLE customer MODIFY COLUMN custname varchar(100);
